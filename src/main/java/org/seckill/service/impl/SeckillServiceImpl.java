...
public class SeckillServiceImpl implements SeckillService {
	...
	//md5盐值字符串，用于混淆MD5
	private final String salt = "dsdsjjoh83348##$$KKj#$#3kdkj#$#()";
	 ...
	 * 3：不是所有的方法都需要事务，如只有一条修改（添加、修改、删除）操作，只读操作不需要事务控制。
	 */
	@Transactional
	@Override
	...
	public SeckillExecution executeSeckillProcedure(long seckillId, long userPhone, String md5){
		...
		try {
			...
			if(result == 1){
				SuccessKilled sk = successKilledDao.queryByIdWithSuccessKilled(seckillId, userPhone);
